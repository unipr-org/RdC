...
- **Conversione per forma d’onda**: il segnale viene convertito usando la trasformata di Fourier, è una tecnica matematica che consente di decomporre u segnale nel dominio di tempo in componenti nel dominio delle frequenze, cioè il segnale viene quindi scomposto nelle sue frequenze costituenti.
